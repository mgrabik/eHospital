namespace App_Doctor.Logic.Model.Service
{
    ...
    {
        private static readonly Visit[] visits = new Visit[] { new Visit("123", new Doctor("doc1","docsur1"), new Patient("pat1","patsur1","12345678910"), new DateTime(2008, 5, 1, 8, 30, 52)),
        ...
        {
            return FakeNetworkClient.visits;
        }
